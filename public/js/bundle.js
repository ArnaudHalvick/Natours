...
var bookTour = exports.bookTour = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee(tourId, startDate) {
    var stripe, session, _error$response;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
        ...
        case 3:
          ...
          _context.prev = 4;
          _context.next = 7;
          return _axios.default.get("/api/v1/bookings/checkout-session/".concat(tourId, "?startDate=").concat(encodeURIComponent(startDate)));
        case 7:
...
if (signupForm) {
  signupForm.addEventListener("submit", function (e) {
    ...
    (0, _signup.signup)(name, email, password, passwordConfirm); // Call signup function
  });
}
...
if (bookingForm) {
  bookingForm.addEventListener("submit", function (e) {
    ...
    (0, _stripe.bookTour)(tourId, startDate); // Pass startDate here
  });
}
},{"./login":"login.js","./mapbox":"mapbox.js","./updateSettings":"updateSettings.js","./signup":"signup.js","./stripe":"stripe.js","./alert":"alert.js"}],"../../node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
