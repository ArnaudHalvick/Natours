...
var handleCreateBookingSubmit = /*#__PURE__*/function () {
  var _ref7 = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee7(e) {
    var form, tourId, startDate, userId, numParticipants, price, paid, res, _err$response4;
    return _regeneratorRuntime().wrap(function _callee7$(_context7) {
      while (1) switch (_context7.prev = _context7.next) {
        case 0:
          e.preventDefault();
...
var initializeCreateBooking = function initializeCreateBooking() {
  ...
  var closeBtn = createModal === null || createModal === void 0 ? void 0 : createModal.querySelector(".close-modal");
  ...
  cancelBtn === null || cancelBtn === void 0 || cancelBtn.addEventListener("click", function () {
    createModal === null || createModal === void 0 || createModal.classList.remove("active");
  });
