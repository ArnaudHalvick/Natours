    ...
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) switch (_context2.prev = _context2.next) {
        case 0:
          _context2.prev = 0;
          _context2.next = 3;
          return fetch("/api/v1/bookings/".concat(bookingId, "/add-travelers"), {
            method: "PATCH",
            headers: {
              "Content-Type": "application/json"
            },
        ...
        case 6:
          data = _context2.sent;
          if (data.status === "success") {
            (0, _alert.showAlert)("success", "Travelers added successfully!");
            window.setTimeout(function () {
              location.reload();
            }, 1500);
          }
    ...
    return _regeneratorRuntime().wrap(function _callee3$(_context3) {
      while (1) switch (_context3.prev = _context3.next) {
        case 0:
          _context3.prev = 0;
          _context3.next = 3;
          return fetch("/api/v1/bookings/".concat(bookingId, "/refund"), {
            method: "POST",
            headers: {
              "Content-Type": "application/json"
            }
...
},{"../utils/alert":"utils/alert.js"}],"handlers/booking.js":[function(require,module,exports) {
"use strict";
...
var BookingHandler = /*#__PURE__*/function () {
  ...
  return _createClass(BookingHandler, [{
    ...
    value: function initializeEventListeners() {
      var _this = this,
        _this$viewTourBtn,
        _this$writeReviewBtn,
        _this$editReviewBtn,
        _this$addTravelersBtn,
        _this$requestRefundBt,
      ...
      document.querySelectorAll(".manage-booking-btn").forEach(function (btn) {
        btn.addEventListener("click", function (e) {
          return _this.handleManageClick(e);
        });
      });
      ...
      (_this$viewTourBtn = this.viewTourBtn) === null || _this$viewTourBtn === void 0 || _this$viewTourBtn.addEventListener("click", function () {
        return _this.handleViewTour();
      });
      (_this$writeReviewBtn = this.writeReviewBtn) === null || _this$writeReviewBtn === void 0 || _this$writeReviewBtn.addEventListener("click", function () {
        return _this.handleWriteReview();
      });
      (_this$editReviewBtn = this.editReviewBtn) === null || _this$editReviewBtn === void 0 || _this$editReviewBtn.addEventListener("click", function () {
        return _this.handleEditReview();
      });
      (_this$addTravelersBtn = this.addTravelersBtn) === null || _this$addTravelersBtn === void 0 || _this$addTravelersBtn.addEventListener("click", function () {
        return _this.handleAddTravelers();
      });
      (_this$requestRefundBt = this.requestRefundBtn) === null || _this$requestRefundBt === void 0 || _this$requestRefundBt.addEventListener("click", function () {
        return _this.handleRequestRefund();
      });

      // Refund modal handlers
      (_document$getElementB = document.getElementById("confirmRefund")) === null || _document$getElementB === void 0 || _document$getElementB.addEventListener("click", function () {
        return _this.confirmRefund();
      });
      (_document$getElementB2 = document.getElementById("cancelRefund")) === null || _document$getElementB2 === void 0 || _document$getElementB2.addEventListener("click", function () {
        return _this.closeAllModals();
      });
    ...
    value: function handleRequestRefund() {
      ...
      setTimeout(function () {
        _this2.managementModal.style.display = "none";
        _this2.refundModal.style.display = "flex";
        // Trigger reflow
        void _this2.refundModal.offsetWidth;
        _this2.refundModal.classList.add("show");

        // Update refund modal content
        document.getElementById("refundTourName").textContent = _this2.manageTourName.textContent;
        document.getElementById("refundStartDate").textContent = _this2.manageStartDate.textContent;
        document.getElementById("refundAmount").textContent = _this2.managePrice.textContent;
      }, 300);
    }
  }, {
    key: "confirmRefund",
    ...
    value: function () {
      var _handleAddTravelersSubmit = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee3(e) {
        var submitBtn, bookingId, numParticipants;
        return _regeneratorRuntime().wrap(function _callee3$(_context3) {
          while (1) switch (_context3.prev = _context3.next) {
            case 0:
              e.preventDefault();
...
},{"../utils/elements":"utils/elements.js","../api/bookingAPI":"api/bookingAPI.js","../utils/alert":"utils/alert.js"}],"api/reviewAPI.js":[function(require,module,exports) {
"use strict";
